# Input Files for the Surface-Slab Models of Ni<sub>2</sub>ZnB<sub>1</sub> and Ni<sub>3</sub>ZnB<sub>12</sub> for computing the Gibb's Free Energy of Hydrogen Adsorption 
